...
impostoRetido salario = 
    ...
    if (salario >= 1903.99 && salario <= 2826.65) then
        salario - 142.8 - (0.075 * (salario - 1903.99))

    else if (salario >= 2826.66 && salario <= 3751.05) then
        salario - 354.8 - (0.15 * (salario - 2826.66))

    else if (salario >= 3751.06 && salario <= 4664.68) then
